...
public class MealFragment extends Fragment {
    public static final String EXTRA_MEAL_ID = "com.sms.mealintent.meal_id";
    public static final String EXTRA_MEAL_LOCATION = "com.sms.mealintent.meal_location";
    public static final String EXTRA_MEAL_DESCRIPTION = "com.sms.mealintent.meal_description";
    public static final String EXTRA_MEAL_UPLOADED_BY = "com.sms.mealintent.uploaded_by";
